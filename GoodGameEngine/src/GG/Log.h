...
#define GG_CORE_ERRO(...)		::GG::Log::GetCoreLogger()->error(__VA_ARGS__)
#define GG_CORE_FATAL(...)		::GG::Log::GetCoreLogger()->fatal(__VA_ARGS__)
...
#define GG_ERRO(...)		::GG::Log::GetClientLogger()->error(__VA_ARGS__)
#define GG_FATAL(...)		::GG::Log::GetClientLogger()->fatal(__VA_ARGS__)
